...
import { BreadcrumbItem,Breadcrumb,Button , Label, Form, FormGroup, Col, Input } from 'reactstrap';
					...
					<div className="col-12 col-md-9">
						<Form onSubmit={this.handleSubmit}>
							...
							<FormGroup row>
								...
								<Col md={10}>
									<Input type='tel' name="telnum" id="telnum" placeholder="Tel. num." value={this.state.telnum} onChange={this.handleInputChange}/>
								</Col>
							</FormGroup>
							<FormGroup row>
							...
							<FormGroup row>
								<Col md={{size:6,offset:2}}>
									<FormGroup check>
										<Label check>
											<Input type='checkbox' name='agree' agree={this.state.agree} onChange={this.handleInputChange}/> 
							...
							<FormGroup row>
								<Col md={{size:6,offset:2}}>
									<Button color="primary" type='submit'> Send Your Feedback</Button>
								</Col>
							</FormGroup>
						</Form>
					</div>
